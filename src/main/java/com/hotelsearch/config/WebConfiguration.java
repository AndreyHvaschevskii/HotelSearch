package com.hotelsearch.config;

import com.hotelsearch.interceptors.SecurityInterceptorAuthReg;
import com.hotelsearch.interceptors.SecurityInterceptorExceptAuthReg;
...
@Configuration
@ComponentScan(basePackages = "com.hotelsearch")
@EnableTransactionManagement
@EnableWebMvc
public class WebConfiguration extends WebMvcConfigurerAdapter {

    private static final String DB_DRIVER = "org.postgresql.Driver";
    private static final String DB_URL = "jdbc:postgresql://localhost:5432/HotelSearch";
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.hotelsearch.entity");
